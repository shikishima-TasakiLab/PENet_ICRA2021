...
class TrainHDF5Dataset(HDF5Dataset):
    def __init__(
        ...
        self.resize_bilinear = Resize(output_size, interpolation=INTER_LINEAR)
        self.resize_nn = Resize(output_size, interpolation=INTER_NEAREST)
